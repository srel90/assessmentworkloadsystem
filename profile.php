...
switch($_POST['mode']):
	...
	case 'update':
		...
		if($database->execute($strsql)){
		$strsql="SELECT u.*,ut.usertype,uu.firstName as mentorName FROM users u LEFT OUTER JOIN usertype ut ON u.userTypeID=ut.userTypeID LEFT OUTER JOIN users uu ON u.mentorID=uu.userID WHERE u.userID='".$_POST['userID']."'";
...
var script= new function() {
	...
	this.initial=function(){
	    ...
	    $('#userTypeID').kendoDropDownList().data("kendoDropDownList").readonly();
				...
				<form id="scriptForm" action="userprofile.php" method="post" name="scriptForm">
					...
					<div>
						...
						<div>
							...
							?>
							<option value="<?php echo $item['userTypeID'];?>" <?php echo $item['userTypeID']==$personal[0]['userTypeID']?'selected="selected"':''?>><?php echo $item['userType'];?>
							</option>
						...
						<div>
							...
							<input id="IDCard" class="input" name="IDCard" type="text" value="<?php echo $personal[0]['IDCard'];?>">*
						...
						<div>
							...
							<input id="userStatus0" name="userStatus" title="Inctive" type="radio" value="1" <?php echo $personal[0]['userStatus']=='1'?'checked="checked"':'';?> >โสด
							<input id="userStatus1" name="userStatus" title="Active" type="radio" value="2" <?php echo $personal[0]['userStatus']=='2'?'checked="checked"':'';?>>สมรส
							<input id="userStatus2" name="userStatus" title="Active" type="radio" value="3" <?php echo $personal[0]['userStatus']=='3'?'checked="checked"':'';?>>หย่า
							<input id="userStatus3" name="userStatus" title="Active" type="radio" value="4" <?php echo $personal[0]['userStatus']=='4'?'checked="checked"':'';?>>หม้าย
						</div>
						<div>
							<label>ที่อยู่ :</label>
							<textarea id="address" class="input" cols="20" name="address" rows="2" title="พิมพ์ที่อยู่"><?php echo $personal[0]['address'];?></textarea>
							<span class="k-invalid-msg" data-for="address">
							</span></div>
						<div>
							<label>เบอร์โทรศัพท์ :</label>
							<input id="phone" class="input" name="phone" title="พิมพ์เบอร์โทรศัพท์" type="text" value="<?php echo $personal[0]['phone'];?>" >
						...
						<div>
							...
							<input id="currentSalary" name="currentSalary" title="พิมพ์อัตรเงินเดือน" type="text" value="<?php echo $personal[0]['currentSalary'];?>">
							<span class="k-invalid-msg" data-for="currentSalary"></span>
						</div>
						<div>
							<label>พี่เลี้ยง:</label>
							<input id="mentorID" class="input" name="mentorID" title="รหัสพี่เลี้ยง" type="hidden" value="<?php echo $personal[0]['mentorID'];?>">
							<input id="mentorName" class="input" name="mentorName" title="พี่เลี้ยง" type="text" style="width:124px" readonly value="<?php echo $personal[0]['mentorName'];?>">
					...
					<fieldset>
						...
						<div>
							...
							<input id="bachelorDegreeDiscipline" class="input" name="bachelorDegreeDiscipline" title="พิมพ์สาขา/สาขาวิชา" type="text" value="<?php echo $personal[0]['bachelorDegreeDiscipline'];?>">
							<span class="k-invalid-msg" data-for="bachelorDegreeDiscipline">
							</span></div>
						<div>
							<label>สถาบันการศึกษา :</label>
							<input id="bachelorDegreeInstitution" class="input" name="bachelorDegreeInstitution" title="พิมพ์สถาบันการศึกษา" type="text" value="<?php echo $personal[0]['bachelorDegreeInstitution'];?>">
							<span class="k-invalid-msg" data-for="bachelorDegreeInstitution">
							</span></div>
						<div>
							<label>ปีที่สำเร็จ :</label>
							<input id="bachelorDegreeGraduate" class="input" name="bachelorDegreeGraduate" title="พิพม์ปีที่สำเร็จ" type="text" value="<?php echo $personal[0]['bachelorDegreeGraduate'];?>">
						...
						<div>
							<label>สาขา/สาขาวิชา :</label>
							<input id="mastersDegreeDiscipline" class="input" name="mastersDegreeDiscipline" title="พิมพ์สาขา/สาขาวิชา" type="text" value="<?php echo $personal[0]['mastersDegreeDiscipline'];?>">
							<span class="k-invalid-msg" data-for="mastersDegreeDiscipline">
							</span></div>
						<div>
							<label>สถาบันการศึกษา :</label>
							<input id="mastersDegreeInstitution" class="input" name="mastersDegreeInstitution" title="พิมพ์สถาบันการศึกษา" type="text" value="<?php echo $personal[0]['mastersDegreeInstitution'];?>">
							<span class="k-invalid-msg" data-for="mastersDegreeInstitution">
							</span></div>
						<div>
							<label>ปีที่สำเร็จ :</label>
							<input id="mastersDegreeGraduate" class="input" name="mastersDegreeGraduate" title="พิพม์ปีที่สำเร็จ" type="text" value="<?php echo $personal[0]['mastersDegreeGraduate'];?>">
						...
						<div>
							<label>สาขา/สาขาวิชา :</label>
							<input id="doctorateDegreeDiscipline" class="input" name="doctorateDegreeDiscipline" title="พิมพ์สาขา/สาขาวิชา" type="text" value="<?php echo $personal[0]['doctorateDegreeDiscipline'];?>">
							<span class="k-invalid-msg" data-for="doctorateDegreeDiscipline">
							</span></div>
						<div>
							<label>สถาบันการศึกษา :</label>
							<input id="doctorateDegreeInstitution" class="input" name="doctorateDegreeInstitution" title="พิมพ์สถาบันการศึกษา" type="text" value="<?php echo $personal[0]['doctorateDegreeInstitution'];?>">
							<span class="k-invalid-msg" data-for="doctorateDegreeInstitution">
							</span></div>
						<div>
							<label>ปีที่สำเร็จ :</label>
							<input id="doctorateDegreeGraduate" class="input" name="doctorateDegreeGraduate" title="พิพม์ปีที่สำเร็จ" type="text" value="<?php echo $personal[0]['doctorateDegreeGraduate'];?>">
						...
						<div>
							<label>สาขา/สาขาวิชา :</label>
							<input id="diplomaDiscipline" class="input" name="diplomaDiscipline" title="พิมพ์สาขา/สาขาวิชา" type="text" value="<?php echo $personal[0]['diplomaDiscipline'];?>">
							<span class="k-invalid-msg" data-for="diplomaDiscipline">
							</span></div>
						<div>
							<label>สถาบันการศึกษา :</label>
							<input id="diplomaInstitution" class="input" name="diplomaInstitution" title="พิมพ์สถาบันการศึกษา" type="text" value="<?php echo $personal[0]['diplomaInstitution'];?>">
							<span class="k-invalid-msg" data-for="diplomaInstitution">
							</span></div>
						<div>
							<label>ปีที่สำเร็จ :</label>
							<input id="diplomaGraduate" class="input" name="diplomaGraduate" title="พิพม์ปีที่สำเร็จ" type="text" value="<?php echo $personal[0]['diplomaGraduate'];?>">
